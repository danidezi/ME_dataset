...
and if for some \myHighlight{$m$}\coordHE{} belonging to the kernel of \myHighlight{$\phi$}\coordHE{} the induced tangent map
at  \myHighlight{$m$}\coordHE{}, \myHighlight{$T_m\phi$}\coordHE{}, is not surjective we call the constraint irregular.

If \myHighlight{$\phi$}\coordHE{} is a regular constraint \myHighlight{$\phi^{-1}(0)$}\coordHE{} always define a
submanifold. If \myHighlight{$\phi$}\coordHE{} is irregular, \myHighlight{$\phi^{-1}(0)$}\coordHE{} is not necessarily a
...
where \myHighlight{$e$}\coordHE{} is a Lagrange multiplier associated to the constraint
\begin{equation}\coord{}\boxEquation{
\label{2}
P^2=0\ \ \ \ \ .
}{
...
The factor \myHighlight{$det\{\ov{\Phi}^\top_1,\ov{\Phi}^\top_1\}^{1/2}$}\coordHE{} in the
measure of the functional integral is in principle as problematic
as the factor \myHighlight{$det\{\phi^\top ,\phi^\top \}^{1/2}$}\coordHE{} in the  direct
...
We iterate now the process and introduce \myHighlight{$\xi_2$}\coordHE{}, \myHighlight{$\eta_2$}\coordHE{} and \myHighlight{$\omega_2$}\coordHE{}.
We obtain again
\begin{equation}\coord{}\boxEquation{
\label{8}
\omega_2 =-2\np \\
...
case \myHighlight{$\np$}\coordHE{}  \myHighlight{$\eta_i$}\coordHE{} and \myHighlight{$\wt{\phi}_i$}\coordHE{}  \myHighlight{$i=0,\cdots ,\infty$}\coordHE{} are
...
The superparticle action on both an \myHighlight{$N=1$}\coordHE{} and \myHighlight{$N=2$}\coordHE{} superworldline was
