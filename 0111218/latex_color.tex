...
of a \myHighlight{$ D = d + 2$}\coordHE{}-dimensional geometry characterized only 
by one bulk coordinate \myHighlight{$w$}\coordHE{} and whose line element can be written as 
...
where \myHighlight{$a(w)$}\coordHE{} is the warp factor and \myHighlight{$\overline{G}_{A B}$}\coordHE{} denotes the 
...
where \myHighlight{$R_{A}^{B}$}\coordHE{} is the Ricci tensor and 
\begin{equation}\coord{}\boxEquation{
...
is constructed from the energy-momentum tensor of the brane \myHighlight{$T_{A}^{B}$}\coordHE{}.
...
\myHighlight{$d+1$}\coordHE{}-dimensional  sub-space whereas the Latin indices run over the full 
\myHighlight{$D$}\coordHE{}-dimensional space-time.}  
...
where \myHighlight{${\cal H} = a'/a$}\coordHE{} and the prime denotes derivation with 
respect to \myHighlight{$w$}\coordHE{}.
...
\overline{R}_{A}^{B} = 8 \pi G_{D} \overline{\tau}_{A}^{B} ,
 ...
 where \myHighlight{$\overline{\tau}_{A}^{B}$}\coordHE{} is the background energy-momentum 
...
form of \myHighlight{$\tau_{A}^{B}$}\coordHE{} is compatible with the specific form of the Ricci 
...
the fluctuations of the Ricci tensors and of the \myHighlight{$\tau_{A}^{B}$}\coordHE{} can be 
written as 
\begin{eqnarray}\coord{}\boxAlignEqnarray{
...
can be classified according to the \myHighlight{$(d+1)$}\coordHE{}-dimensional Poincar\'e invariance 
...
In Eq. (\ref{pm}) \myHighlight{$h_{\mu\nu}$}\coordHE{} is a divergence-less and trace-less 
[i.e.\myHighlight{$\partial_{\mu} h^{\mu}_{\nu} =0$}\coordHE{}, \myHighlight{$h_{\mu}^{\mu} =0$}\coordHE{}]
rank-two tensor in the \myHighlight{$(d+1)$}\coordHE{}-dimensional Poincar\'e invariant 
space-time. The vectors \myHighlight{$f_{\mu}$}\coordHE{} and \myHighlight{$D_{\mu}$}\coordHE{} are both divergence-less
[i.e. \myHighlight{$\partial_{\mu} D^{\mu} =\partial_{\nu} f^{\nu} =0$}\coordHE{}]. 
The other functions are 
scalars under Poincar\'e transformations. 
The number of independent functions parameterizing the fluctuations 
of the metric is then \myHighlight{$(d+2)(d+3)/2$}\coordHE{}.
...
where \myHighlight{$\epsilon^{A}$}\coordHE{} stands for the \myHighlight{$(d+2)$}\coordHE{} functions 
...
of the vector \myHighlight{$\epsilon^{A}$}\coordHE{}
\begin{equation}\coord{}\boxEquation{
...
where \myHighlight{$\epsilon_A = a^2(w) (\epsilon_{\mu}, -\epsilon_{w})$}\coordHE{}. We can always 
use \myHighlight{$(d+1)$}\coordHE{}-dimensional Poincar\'e invariance in order to 
...
with \myHighlight{$\partial_{\mu} \zeta^{\mu} =0$}\coordHE{}. Hence, while \myHighlight{$\zeta_{\mu}$}\coordHE{} 
transforms as a pure (i.e. divergence-less vector), \myHighlight{$\epsilon $}\coordHE{} and 
\myHighlight{$\epsilon_{w}$}\coordHE{} are scalars.

The tensor mode of the metric, i.e.
\myHighlight{$h_{\mu\nu}$}\coordHE{} are automatically invariant under the transformation 
...
\myHighlight{$\epsilon$}\coordHE{} and \myHighlight{$\epsilon_{w}$}\coordHE{}],
...
where \myHighlight{$\delta^{{\rm (gi)}}$}\coordHE{} denotes a variation which 
...
tensor we can also write the fluctuations of \myHighlight{$\tau_{A}^{B}$}\coordHE{} in 
...
Consider now, for sake of simplicity, the case \myHighlight{$d=3$}\coordHE{} (the same 
can be however discussed for a generic \myHighlight{$d$}\coordHE{}).
...
The gauge-invariant fluctuation  of \myHighlight{$\tau_{A}^{B}$}\coordHE{} will instead be:
\begin{eqnarray}\coord{}\boxAlignEqnarray{
...
where \myHighlight{$ \delta \Gamma^{C}_{A B}$}\coordHE{} are the fluctuations of the connections.
...
Notice, incidentally, that \myHighlight{${\cal G}$}\coordHE{} represent the canonical normal modes 
of the action.
...
with respect to \myHighlight{$z\rightarrow 1/z$}\coordHE{}. This property can be used in order to 
...
Under the duality transformation \myHighlight{$z \rightarrow 1/z$}\coordHE{} 
the superpotentials related to the equation for \myHighlight{$\Phi$}\coordHE{} and \myHighlight{${\cal G}$}\coordHE{} 
...
related to the one of Eq. (\ref{me}) as \myHighlight{$a(w) dw = dy$}\coordHE{}.}.
...
and with \myHighlight{$d=3$}\coordHE{} in the case of a four-dimensional Poincar\'e invariant 
world.
