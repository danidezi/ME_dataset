...
\myHighlight{$2.18$}\coordHE{} seconds. In the case of infrared photons with the frequency
of \myHighlight{$9\cdot 10^{13} Hz$}\coordHE{}, interference must vanish already at the
...
distance \myHighlight{$(r)$}\coordHE{} travelled by a transverse wave on a string, until
...
energy of photons (\myHighlight{$E_{max}=h\nu$}\coordHE{}) must be equal to their maximum
...
of time. This basic unit of action must be equal to \myHighlight{$h$}\coordHE{}. Hence,
...
have an action potential comparable to \myHighlight{$h$}\coordHE{}. Yet, when the waves on
a string have already decayed to \myHighlight{$E'=\nu'h$}\coordHE{}, with
\myHighlight{$\nu'=10^{-3}Hz$}\coordHE{}, the deflection of the weakest photon cannot
exceed \myHighlight{$0.06$}\coordHE{} degrees (small enough to eliminate interference
build-up in most experimental settings). Thus, the value of \myHighlight{$r$}\coordHE{}
corresponds to the distance travelled by a string wave until its
energy \myHighlight{$E_{max}$}\coordHE{} decays to \myHighlight{$E'$}\coordHE{}. (\myHighlight{$r_{0}^{2}E_{max}=r^{2}E'$}\coordHE{},
where \myHighlight{$r_{0}$}\coordHE{} is the unit of distance corresponding to the system
of units used to measure \myHighlight{$E$}\coordHE{}). The equation for the corresponding
time simplifies to \myHighlight{$t=r_{0}\sqrt{\nu}/c\sqrt{\nu'}$}\coordHE{}.
...
(the most widely used in interferometric experiments), \myHighlight{$t=2.18$}\coordHE{}
seconds. Other visible colors can produce interference at even
larger intervals. At the same time, infrared photons with
\myHighlight{$\nu=9\cdot 10^{13} Hz$}\coordHE{} must loose their fringe visibility at
\myHighlight{$t=1$}\coordHE{} second. Hence, it is only normal for the double slit
...
particle passes through the system at the same time, provided the gap (\myHighlight{$t$}\coordHE{})
...
(beyond two seconds), in order to verify the equation for \myHighlight{$t$}\coordHE{}. It
...
beyond the specified values of \myHighlight{$t$}\coordHE{} would falsify the theory.
