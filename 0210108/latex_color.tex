...
\noindent where \myHighlight{$\eta_{00} = -1 $}\coordHE{} and \myHighlight{$\eta_{\alpha\beta} = \delta_{\alpha\beta}$}\coordHE{}
with \myHighlight{$\alpha$}\coordHE{}, \myHighlight{$\beta = 1,2,...p$}\coordHE{},
\myHighlight{$T(x)$}\coordHE{} is the scalar tachyon field and  V(T) is the tachyon potential,
...
\noindent where \myHighlight{$ \alpha=1$}\coordHE{} (bosonic, \myHighlight{$p=25$}\coordHE{}) and ,\myHighlight{$\alpha =  \sqrt{2}$}\coordHE{}
(superstring, \myHighlight{$p=9$}\coordHE{}).
...
via the correspondence :-  \myHighlight{$x^{i} \rightarrow t$}\coordHE{}, \myHighlight{$T\rightarrow x$}\coordHE{} and 
\myHighlight{$V(T)\rightarrow V(x)$}\coordHE{} :
...
The equation of motion for this action (with the assumption that \myHighlight{$1-{\dot x}^2
\neq 0$}\coordHE{}--the equality corresponds, as evident from the discussion below, of
...
where \myHighlight{$f(x) = -\frac{1}{V}\frac{\partial V}{\partial x}$}\coordHE{}.
Using the zero dimensional version of the tachyon potential, i.e. 
\myHighlight{$V(x) = e^{-\alpha x}$}\coordHE{} (we do away with the \myHighlight{$\frac{1}{2}$}\coordHE{} factor in
...
Redefining \myHighlight{$\dot x = \gamma \dot y$}\coordHE{} we obtain :
...
Replacing \myHighlight{$\alpha \gamma =\frac{\beta}{m}$}\coordHE{} and \myHighlight{$\frac{\alpha}{\gamma} = g$}\coordHE{}
we get back :
...
which is the equation of motion of a particle of mass \myHighlight{$m$}\coordHE{} moving in a
...
to its \myHighlight{$n$}\coordHE{}th power (recall the fact that the square root and the squared
...
for \myHighlight{$n=1$}\coordHE{} (and no other value of \myHighlight{$n$}\coordHE{})we get the
...
\myHighlight{$\sqrt{1-{\dot x}^2}$}\coordHE{} by \myHighlight{$\sqrt{1+{\dot x}^2}$}\coordHE{}. This yields a wrong sign 
in the right hand side \myHighlight{$m\ddot y +\beta {\dot x}^2 = -mg$}\coordHE{}.
...
of \myHighlight{$m\ddot y = mg$}\coordHE{} and its effect on the
...
freedom in choosing \myHighlight{$V(x)$}\coordHE{} may be useful in situations with more complicated
...
It is tempting, as a follow-up exercise, to extend the above ideas to \myHighlight{$1+1$}\coordHE{}
...
\myHighlight{${\phi'}^2$}\coordHE{} term, which will be present in the equations of motion,
