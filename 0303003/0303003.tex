...
%However, somewhat similar to the situation pointed out in 
%5\cite{BVW}, in some cases an extra term must be added on. In our case it is due to 
%the non-factorisable geometry of the spacetime.
...
%\bibitem{BVW} S.~Blau, M.~Visser and A.~Wipf, Nucl.\ Phys.\ B {\bf 310} (1988) 163.

\end{thebibliography}

\end{document}\\Documents\\Documents\\Documents\\Documents\\Documents