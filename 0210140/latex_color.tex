...
form factor with the energy scale, \myHighlight{$\Lambda_{GM}< 1-10$}\coordHE{} TeV.
\end{abstract}
...
functions
\myHighlight{${\cal G}(x)=\exp\biggl[-{\cal D}(x)/\Lambda_G^2\biggr]$}\coordHE{},
and
\myHighlight{${\cal F}(x)=\exp\biggl[-({\cal D}(x)+m^2)/\Lambda_M^2\biggr]$}\coordHE{},
...
forms of energy}, including the vacuum energy density \myHighlight{$\rho_{\rm
vac}$}\coordHE{}, so we cannot ignore these virtual quantum
fluctuations in the presence of a non-zero gravitational field.
Quantum corrections to \myHighlight{$\lambda_0$}\coordHE{} come from loops formed from
...
\myHighlight{$F_{\mu\alpha}=\partial_\mu A_\alpha-\partial_\alpha A_\mu$}\coordHE{}.
...
\myHighlight{${\cal G}^{\rm GM}(q^2)
=\exp\biggl[-q^2/\Lambda_{GM}^2\biggr]$}\coordHE{}.
...
scale \myHighlight{$\Lambda_{{\rm Gvac}} < 10^{-3}$}\coordHE{} eV~\cite{Moffat2}.
...
\myHighlight{$\Lambda_{\rm Gvac}=\Lambda_M^2/M_{\rm PL}=2.1\times 10^{-3}$}\coordHE{}
eV.}
...
is
\myHighlight{$\label{Friedmann}
H^2\sim 8\pi G{\bar\rho}_{\rm vac}/3$}\coordHE{},
where \myHighlight{$H={\dot R}/R$}\coordHE{}, \myHighlight{$R$}\coordHE{} denoting the cosmic
scale and \myHighlight{${\bar\rho}_{\rm vac}=\lambda_0/8\pi
G+\rho_{\rm vac}$}\coordHE{} is the effective vacuum energy density,
...
``natural'' value with a cutoff \myHighlight{$\Lambda_c\sim  M_{PL}$}\coordHE{}, then the
...
\myHighlight{$H < H_0\sim 10^{-33}$}\coordHE{} eV in agreement with observations.
